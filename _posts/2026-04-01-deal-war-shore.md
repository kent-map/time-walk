...
Primarily known for its long stretch of shingle beach, [Deal]({{ site.baseurl }}/seascape/deal) may appear like any seaside town to most, but there is a vast history below the waves and onshore. The town has been involved in war and conflict throughout time. Let us explore Deal's rich military history.

{% include embed/image.html src="https://raw.githubusercontent.com/kent-map/kmo-forum-images/main/9a5975c8-3fc2-4974-b85a-3c666bcb5ad4.jpg" aspect="1.538" caption="Rough Sea at Deal" attribution="Kent Maps Online Collection" %}
...
{% include embed/image.html src="wc:Plate_1-_Julius_Caesar_looking_to_the_right%2C_from_%27The_Twelve_Caesars%27_MET_DP846534.jpg" aspect="0.717" caption="Julius Caesar Looking to the right" %}

Caesar ordered a fleet of 80 ships for the invasion. On their travels, they faced extreme winds and a fierce battle with the Goodwin Sands. The horrid weather unsettled the horses on board, and Caesar's men struggled to calm them down. Most of the ships returned to safety to prevent any injuries or damages. Unaware of the retreat, Caesar continued his pursuit. The ships dropped their anchors off the coast and the troops planned to swim the rest of the short journey to shore. However, as they wore traditional Roman armour; most of them drowned. It is believed that Caesar managed to land on Walmer Beach where he stayed for four days. The following year, better prepared, Caesar attempted to invade the Kentish coast again. He ordered a larger fleet of ships this time round. However, Caesar faced rough winds again, and the ships were forced off course and ended up in Thanet. 
...
{% include embed/image.html src="wc:lossy-page1-1197px-Seamen_painting_a_jolly_boat_%28Bray_album%29_RMG_PT1984.tiff.jpg" aspect="1.169" caption="Seamen painting a jolly boat - Bray Album" %}
...
{% include embed/image.html src="wc:Catherine_Aragon_Henri_VIII_by_Henry_Nelson_ONeil.jpg" aspect="1.282" caption="Catherine of Aragon pleads her case against divorce from Henry VIII" %}
...
{% include embed/image.html src="wc:thumbnail.jpg" aspect="3.36" caption="Dealam Castrum et Sandvicum" %}

{% include embed/image.html src="wc:Deal_Castle_1539_draft.jpg" aspect="0.863" caption="Deal Castle, 1539" %}
...
{% include embed/image.html src="wc:Site_of_Sandown_Castle%2C_Deal_-_geograph.org.uk_-_4436351.jpg" aspect="1.333" caption="Site of Sandown Castle" %}
...
{% include embed/image.html src="wc:King_Charles_I_by_Gerrit_van_Honthorst_sm.jpg" aspect="0.831" caption="King Charles I" %}
...
{% include embed/image.html src="wc:Royal_Marines_Band_Drum_MOD_45155555.jpg" aspect="0.664" caption="Royal Marines Band Drum" %}
...
{% include embed/image.html src="wc:Deal_Barracks_Bombing_memorial_garden.jpg" aspect="0.562" caption="Deal Barracks Bombing Memorial Gardens" %}
...
{% include embed/image.html src="wc:Ex%C3%A9cution_de_Louis_XVI_Carnavalet.jpg" aspect="1.5" caption="Execution of Louis XVI" %}
...
{% include embed/image.html src="wc:Loss_of_HMS_Aboukir%2C_Royal_Navy%2C_artwork_by_Norman_Wilkinson_%2819597630639%29.jpg" aspect="1.649" caption="Loss of HMS Aboukir" %}
...
{% include embed/image.html src="wc:British_Battleships_of_the_First_World_War_Q40389.jpg" aspect="1.342" caption="HMS Vanguard, British Battleships of the First World War" %}
...
{% include embed/image.html src="wc:The_Clarendon_Hotel%2C_Beach_Street%2C_Deal_-_geograph.org.uk_-_1718083.jpg" aspect="1.333" caption="The Clarendon Hotel, Beach Street, Deal" %}
...
{% include embed/image.html src="wc:Walmer_Lifeboat_Charles_Dibdin.jpg" aspect="1.575" caption="Postcard of lifeboat Charles Dibdin at the Lifeboat Station, Walmer, before 1948" %}
...
{% include embed/image.html src="wc:Deal_Walmer_Sandown_Saunders_Guidebook_Page005.jpg" aspect="0.549" caption="Saunders Guidebook, p.5" %}
